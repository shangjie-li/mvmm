...
class PFE13(nn.Module):
    def __init__(self, model_cfg, input_channels, point_cloud_range, training, **kwargs):
        ...
        self.pfn_layers = PFNLayer(self.base_channels + self.extra_channels + self.num_class, self.num_pv_features)
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        for batch_idx in range(batch_size):
            ...
            pv_features = torch.cat([pv_features, pv_seg_features], dim=-1)
